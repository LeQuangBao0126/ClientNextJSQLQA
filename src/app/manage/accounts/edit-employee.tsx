...
export default function EditEmployee({
    ...
    const onSubmit = async (values: UpdateEmployeeAccountBodyType) => {
        ...
        let body: { id: number } & UpdateEmployeeAccountBodyType = { id: id as number, ...values }
        if (file) {
        ...
        // add thành công là invalidate queries 
    ...
    return (
        ...
        >
            <DialogContent className='sm:max-w-[600px] max-h-screen overflow-auto'>
                ...
                <Form {...form}>
                    <form noValidate className='grid auto-rows-max items-start gap-4 md:gap-8' id='edit-employee-form' onSubmit={form.handleSubmit(onSubmit, e=>{
                        console.log("Lỗi cập nhật account  ",e)
                    })}>
