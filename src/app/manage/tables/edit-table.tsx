...
import { useGetTableQuery, useUpdateTable } from '@/queries/useTable'
...
export default function EditTable({
    ...
    const onSubmit = async (values: UpdateTableBodyType) => {
        ...
        let body: { id: number } & UpdateTableBodyType = { id: id as number, ...values }

        const result = await updateTableMutation.mutateAsync(body)
        toast({description: result.payload.message ,variant:'default'})
            ...
            >
                ...
                <Form {...form}>
                    <form noValidate className='grid auto-rows-max items-start gap-4 md:gap-8' id='edit-table-form'
                        onSubmit={form.handleSubmit(onSubmit, e => { console.log("Lỗi khi cập nhật bàn ăn", e) })}
                    >
