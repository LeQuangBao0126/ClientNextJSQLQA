...
export default function EditDish({
    ...
    useEffect(() => {
        //fetch detail dish  
        if (data) {
            const { description, name, price, status, image} = data.payload.data
            form.reset({
                description, name, price, status , 
                image:  image  
            })
        }
    }, [data, form])
     ...
     const onSubmit = async (values: UpdateDishBodyType) => {
            ...
            let body: { id: number } & UpdateDishBodyType = { id: id as number, ...values }
            if (file) {
            ...
            <DialogContent className='sm:max-w-[600px] max-h-screen overflow-auto'>
                ...
                <Form {...form}>
                    ...
                    onSubmit={form.handleSubmit(onSubmit , e => { 
                        console.log("Lỗi khi cập nhật món ăn" , e)
                    })}>
